![Part 1 - Tampa Logo](./img/logo.png "Copyright BSides Tampa")
...
Follow the instructions below, to fork https://github.com/tweag/bsides-tampa-workshop
...
Next generate a token. Go to the `Security` tab and generate a new token, call it `bsides-tampa-demo`.
...
codeql-csharp-consistency-queries (/bsidestampa/qlpacks/codeql/csharp/ql/consistency-queries)
codeql-csharp-tests (/bsidestampa/qlpacks/codeql/csharp/ql/test)
codeql-go-consistency-queries (/bsidestampa/qlpacks/codeql/go/ql/consistency-queries)
codeql-java-consistency-queries (/bsidestampa/qlpacks/codeql/java/ql/consistency-queries)
...
./codeql database create --language=javascript-typescript --source-root ../bsides-tampa-workshop/part1 ../javascript-database
...
Initializing database at /bsidestampa/javascript-database.
Running build command: []
[2024-03-22 09:20:15] [build-stdout] Single-threaded extraction.
[2024-03-22 09:20:15] [build-stdout] Extracting /bsidestampa/bsides-tampa-workshop/part1/src/vuln.js
[2024-03-22 09:20:15] [build-stdout] Done extracting /bsidestampa/bsides-tampa-workshop/part1/src/vuln.js (327 ms)
[2024-03-22 09:20:15] [build-stderr] No externs trap cache found

...

Finalizing database at /bsidestampa/javascript-database.
Running TRAP import for CodeQL database at /bsidestampa/javascript-database...
